<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master/Guest.Master" AutoEventWireup="true" CodeBehind="detail_service.aspx.cs" Inherits="KpopZtation.View.ServiceFolder.detail_service" %>
    ...
    <div class="containerAlbm">
        <div class="product-card">
            ...
            <div class="stock-controls">
                ...
                <asp:Button ID="addToCartBtn" runat="server" Text="Add to Cart" OnClick="addToCartBtn_Click" Visible="false" CssClass="add-to-cart-button" />
            </div>
            <div>
